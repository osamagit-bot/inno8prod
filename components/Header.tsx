          ...
          >
            ...
            <div className="flex space-x-3">
              <a
                ...
                onMouseLeave={(e) => (e.currentTarget.style.color = colors.secondary_color)}
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
        ...
        <nav className="container mx-auto px-4 py-6">
              ...
              {menuItems.map((item, index) =>
                item.children ? (
                  <div key={index} className="relative group">
                    <a
                      href={item.url}
                      className="transition-colors font-medium flex items-center space-x-1 py-2 text-gray-600 hover:text-blue-600"
                    >
                      <span>{item.name}</span>
                      <svg
                      ...
                      <div className="py-2">
                        {item.children.map((child: any, childIndex: number) => (
                          <a
                            key={childIndex}
                            href={child.url}
                            className="relative block px-4 py-2 transition-colors overflow-hidden group/item text-gray-600 hover:text-white"
                          >
                            <span className="relative z-10">{child.name}</span>
                            <div
                              className="absolute inset-0 transform -translate-x-full group-hover/item:translate-x-0 transition-transform duration-500 ease-out"
                  ...
                  <a
                    key={index}
                    href={item.url}
                    className="transition-colors font-medium text-gray-600 hover:text-blue-600"
                  >
                    {item.name}
                  </a>
                ),
          ...
          {(isMenuOpen || showOverlay) && (
            <>
              ...
              {/* Mobile Menu */}
              <div
                className={`fixed top-0 right-0 h-full w-full max-w-sm shadow-xl z-50 lg:hidden transform transition-transform duration-700 ease-in-out overflow-hidden ${
              ...
              >
                <div className="p-6 h-full overflow-y-auto">
                      ...
                      <img
                        src={
                          siteSettings.mobile_logo
                            ? getImageUrl(siteSettings.mobile_logo)
                            : "/images/inoo8%20With%20Bg.jpg"
                        }
                  ...
                  <div className="mb-6 pb-4 border-b border-white border-opacity-20">
                    ...
                    <div className="space-y-2">
                      <a
                        ...
                        className="flex items-center space-x-2 text-white text-opacity-80 hover:text-opacity-100 transition-colors text-sm"
                      >
                        <svg
                    ...
                    {menuItems.map((item, index) =>
                      item.children && item.children.length > 0 ? (
                        <div key={index}>
                          <div className="flex items-center justify-between w-full py-2">
                            <a
                              href={item.url}
                              onClick={closeMenu}
                              className="text-white hover:text-opacity-80 transition-colors font-medium flex-1"
                            >
                              {item.name}
                            </a>
                            <button
                            ...
                            >
                              <svg
                                className={`w-4 h-4 transform transition-transform duration-200 ${openDropdown === item.name.toLowerCase() ? "rotate-180" : ""}`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                              ...
                              {item.children.map(
                                (child: any, childIndex: number) => (
                                  <a
                                    key={childIndex}
                                    href={child.url}
                                    className="block text-white text-opacity-70 hover:text-opacity-100 transition-colors py-1 text-sm"
                                  >
                                    {child.name}
                                  </a>
                                ),
                        ...
                        <a
                          ...
                          href={item.url}
                          onClick={closeMenu}
                          className="block text-white hover:text-opacity-80 transition-colors font-medium py-2"
                        >
                          {item.name}
                        </a>
                      ),
                  ...
                  <a
                    href="/contact"
                    className="relative block w-full px-6 py-4 rounded-sm font-medium mb-6 overflow-hidden group border border-blue-500 text-white hover:bg-blue-500 transition-all duration-300 text-center"
                  >
                  ...
                  <div className="border-t border-white border-opacity-20 pt-4 mt-6">
                    ...
                    <div className="grid grid-cols-5 gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center w-10 h-10 bg-white bg-opacity-10 rounded-lg text-white hover:bg-opacity-20 transition-colors"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="currentColor"
