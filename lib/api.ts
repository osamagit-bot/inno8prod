...
export const API_ENDPOINTS = {
  ...
  TESTIMONIAL_SUBMIT: `${API_CONFIG.BASE_URL}/api/testimonial-submit/`,
  CONTACT_SUBMISSIONS: `${API_CONFIG.BASE_URL}/api/contact-submissions/`,
  TESTIMONIAL_SUBMISSIONS: `${API_CONFIG.BASE_URL}/api/testimonial-submissions/`,
  ADMIN_CONTACT_SUBMISSIONS: `${API_CONFIG.BASE_URL}/api/admin/contact-submissions/`,
  ADMIN_TESTIMONIAL_SUBMISSIONS: `${API_CONFIG.BASE_URL}/api/admin/testimonial-submissions/`,
